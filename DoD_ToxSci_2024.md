...
#barplot
barplot(enGOCBf_c3, showCategory=10, font = 15, title = "Cardboard Flaming -3X")+ 
...
#barplot
barplot(enGOPLf_c3, showCategory=10, font = 15, title = "Plastic Flaming -3X")+ 
  scale_x_continuous(breaks = seq(0, 10, by = 5), limits=c(0,10))+
  theme(axis.text.y = element_text(lineheight = 0.7, size = 15),
        title = element_text(size = 15, face="bold"))+
  scale_y_discrete(label=function(y) stringr::str_trunc(y, 40))
...
barplot(enGOPLf_c3, showCategory=10, font = 15, title = "Plastic Flaming -1X")+ 
  scale_x_continuous(breaks = seq(0, 10, by = 5), limits=c(0,10))+
  theme(axis.text.y = element_text(lineheight = 0.7, size = 15),
        title = element_text(size = 15, face="bold"))+
  scale_y_discrete(label=function(y) stringr::str_trunc(y, 40))
...
x$Groups <- str_replace_all(x$Groups, c("PBS_Mock_1" = "Control_1X",
                                        "PBS_Mock_3" = "Control_3X",
                                        "PF_Mock_1" = "Plastic_1X",
                                        "PF_Mock_3" = "Plastic_3X",
                                        "CF_Mock_1" = "Cardboard_1X",
                                        "CF_Mock_3" = "Cardboard_3X"))
...
x2 = list( Groups = c(Cardboard_1X = "green", Cardboard_3X = "seagreen",
                      Plastic_1X = "skyblue", Plastic_3X = "navyblue",
                      Control_1X = "lightyellow", Control_3X = "yellow"),
...
x$Groups <- str_replace_all(x$Groups, c("PBS_Mock_1" = "Control_1X",
                                        "PBS_Mock_3" = "Control_3X",
                                        "CF_Mock_1" = "Flaming_1X",
                                        "CF_Mock_3" = "Flaming_3X"))
...
x2 = list( Groups = c(Flaming_3X = "orange", Flaming_1X = "yellow",
                      Control_3X = "darkgray", Control_1X = "white"),
           Donors = c(Female = "violet", 
                      Male = "purple"))
...
pheatmap(temp3,
         ...
         annotation_colors = x2,
         show_colnames = F,
         main = 'Cardboard flaming\n(common between single and multiple exposures)',
         treeheight_col = 9, 
         fontsize_row = 7, 
         scale = 'row', 
         fontsize_col = 7, 
...
x$Groups <- str_replace_all(x$Groups, c("PBS_Mock_1" = "Control_1X",
                                        "PBS_Mock_3" = "Control_3X",
                                        "CS_Mock_1" = "Smoldering_1X",
                                        "CS_Mock_3" = "Smoldering_3X"))
...
x2 = list( Groups = c(Smoldering_3X = "orange", Smoldering_1X = "yellow",
                      Control_3X = "darkgray", Control_1X = "white"),
           Donors = c(Female = "violet", 
                      Male = "purple"))
...
x$Groups <- str_replace_all(x$Groups, c("PBS_Mock_1" = "Control_1X",
                                        "PBS_Mock_3" = "Control_3X",
                                        "PF_Mock_1" = "Flaming_1X",
                                        "PF_Mock_3" = "Flaming_3X"))
...
x$Groups <- str_replace_all(x$Groups, c("PBS_Mock_1" = "Control_1X",
                                        "PBS_Mock_3" = "Control_3X",
                                        "PS_Mock_1" = "Smoldering_1X",
                                        "PS_Mock_3" = "Smoldering_3X"))
...
saveWorkbook(blank_excel, file = "Table S2 Female.xlsx", overwrite = TRUE)
...
saveWorkbook(blank_excel, file = "Table S3 Male.xlsx", overwrite = TRUE)
```
